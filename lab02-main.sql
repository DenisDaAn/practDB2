...
INSERT INTO scontract(number_contract, date_contract, kod_customer, sum_contract) VALUES 
        (2800800, '2022-09-21', 00, 8933.66),
        (5021652, '2022-08-02', 20, 2084.03),
        (7707189, '2022-09-12', 02, 38083.7),
        (1671398, '2022-05-20', 09, 26370.2),
        (8375890, '2022-09-07', 48, 26415.94),
        (2783565, '2022-06-23', 21, 21957.11),
        (2141653, '2022-01-08', 08, 11309.46),
        (4698099, '2022-04-03', 42, 30107.3),
        (6202274, '2022-10-21', 11, 13940.21),
        (8182727, '2022-07-03', 02, 28158.29),
        (7725317, '2022-01-04', 07, 26520.36),
        ...
        (7144155, '2022-06-25', 39, 20803.09);
...
INSERT INTO  plan(number_contract, kod_product, delivery_time, kod_delivery, sum_deilvery) VALUES 
        (21648, 7113326, '00:50', 685, 1530.85),
        (21676, 7672231, '05:18', 162, 1129.29),
        (21651, 2596256, '13:54', 266, 1403.71),
        (21656, 3208989, '03:38', 732, 1598.98),
        (21655, 8242747, '03:33', 940, 1651.52),
        (21671, 7358198, '07:42', 425, 1245.79),
        (21665, 8112815, '04:11', 742, 958.89),
        (21661, 6384284, '03:20', 812, 1247.5),
        (21686, 5560674, '00:44', 988, 1746.15),
        (21648, 6413367, '01:05', 971, 1441.54),
        (21666, 7476006, '19:08', 514, 1340.6),
        (21649, 8774174, '13:22', 133, 1745.99),
        (21660, 8979024, '15:23', 660, 954.82),
        (21659, 6397161, '13:40', 913, 991.0),
        (21665, 3150804, '01:13', 759, 1234.44),
        (21656, 2870375, '09:31', 397, 923.38),
        (21648, 8874895, '12:26', 555, 1294.15),
        (21675, 4938007, '07:31', 653, 1048.36),
        (21675, 8345720, '00:47', 565, 1533.86),
        (21691, 1080957, '04:51', 639, 1223.56),
        (21657, 9713326, '01:53', 591, 711.27),
        (21664, 2373453, '16:33', 984, 1732.76),
        (21671, 9248263, '05:18', 511, 690.71),
        (21649, 3828054, '17:01', 712, 1279.99),
        (21675, 3333769, '18:33', 792, 1453.0),
        (21684, 8069277, '13:46', 423, 1721.49),
        (21667, 5977930, '14:25', 674, 730.73),
        (21645, 1937714, '12:12', 416, 1354.62),
        (21657, 4907266, '14:34', 307, 1371.39),
        (21660, 4949274, '02:51', 438, 1081.99),
        (21682, 6100836, '14:00', 366, 1303.07),
        (21658, 3130451, '03:48', 834, 1481.19),
        (21670, 2569075, '08:00', 321, 1423.8),
        (21667, 4438766, '16:52', 166, 1078.74),
        (21650, 3329689, '19:32', 757, 970.59),
        (21681, 7138875, '05:52', 334, 1815.02),
        (21695, 8891589, '10:24', 947, 1183.39),
        (21664, 2425339, '18:48', 455, 1926.47),
        (21681, 9205079, '02:17', 740, 1422.73),
        (21672, 8660264, '06:14', 188, 1125.7),
        (21651, 5795394, '14:25', 632, 1848.94),
        (21694, 5134219, '05:59', 368, 1593.33),
        (21676, 6924741, '16:33', 387, 1504.84),
        (21656, 8185867, '15:49', 622, 1793.0),
        (21659, 3688134, '16:20', 531, 1258.19),
        (21678, 2023784, '19:19', 166, 1483.18),
        (21677, 9495357, '15:27', 137, 1645.19),
        (21666, 8694768, '09:22', 439, 1480.48),
        (21652, 8416373, '04:35', 802, 1199.36),
        (21658, 3415657, '05:46', 294, 766.92);
...
INSERT INTO  warehouse(kod_warehouse, name_warehouse, responsible_person, address_warehouse) VALUES 
        (0, 'Art Staying', 'Glover Micheal', 'Microraion Zelenyi d. 32'),
        ...
        (51, 'Art Lane', 'Shirley Moore', 'ul. Tsvetochnaya d18'),
        (52, 'Queen Route', 'Bessie James', 'prosp. Stroiteley d. 56'),
        (53, 'Knight Lane', 'Lee Stevens', 'Castle Court d.42'),
        (54, 'Brewers Lane', 'Doyle Ruth', 'Castle Court d.24'),
        (55, 'Art Lane', 'Carlson Julia', 'Castle Court d.9'),
        (56, 'Winter Way', 'Morrison Morrison', '3th Microraion d. 39'),
        (57, 'Fleet Passage', 'Naomi Johnson', 'Brewers Lane d.33'),
        (58, 'Knight Lane', 'Johnson Hall', 'Bolton Road d. 43'),
        (59, 'Art Lane', 'Dorothy Jennifer', 'Hazelnut Lane d.59'),
        (60, 'Brewers Lane', 'Sarah Michael', 'Microraion Zelenyi d. 36'),
        (61, 'Winter Way', 'Barbara Gregory', 'Hazelnut Lane d.18'),
        (62, 'Brewers Lane', 'David Campbell', 'Microraion Zelenyi d. 1'),
        (63, 'Art Lane', 'Eugene Smith', 'prosp. Stroiteley d. 17'),
        (65, 'Hawthorn Way', 'Lillian Brown', 'Hazelnut Lane d.23'),
        (64, 'Queen Route', 'Price FernandezMae', 'Microraion Zelenyi d. 52'),
        (66, 'Brewers Lane', 'James Estrada', 'Microraion Zelenyi d. 47'),
        (67, 'Queen Route', 'James Matthew', '3th Microraion d. 65'),
        (68, 'Silver Avenue', 'Maria Martin', 'Microraion Zelenyi d. 10'),
        (69, 'Queen Route', 'Estrada Campbell', 'ul. Tsvetochnaya d35'),
        (70, 'Hawthorn Way', 'Johnson Jessie', 'Bolton Road d. 64'),
        (71, 'Silver Avenue', 'Johnson Price', 'Bolton Road d. 66'),
        (72, 'Brewers Lane', 'Martin Hall', 'Bolton Road d. 1'),
        (73, 'Hawthorn Way', 'Ortiz Ricky', 'prosp. Stroiteley d. 8'),
        (74, 'Silver Avenue', 'Brown Andrew', 'Alexander Street d. 63'),
        (75, 'Fleet Passage', 'Marsha Clark', 'ul. Tsvetochnaya d48'),
        (76, 'Winter Way', ' Collins', 'Brewers Lane d.38'),
        (77, 'Silver Avenue', 'James Holmes', 'Hazelnut Lane d.60'),
        (78, 'Hawthorn Way', 'Peterson Eugene', 'Alexander Street d. 42'),
        (79, 'Silver Avenue', 'Charles Miller', '3th Microraion d. 8'),
        (80, 'Silver Avenue', 'Glover Alexander', 'Castle Court d.65'),
        (81, 'Hawthorn Way', 'Campbell Joseph', '3th Microraion d. 40'),
        (82, 'Hazelnut Lane', 'David Pearson', 'Castle Court d.26'),
        (83, 'Hawthorn Way', 'Bessie Johnson', 'Bolton Road d. 68'),
        (84, 'Queen Route', 'FernandezMae Charles', 'Bolton Road d. 23'),
        (85, 'Winter Way', 'Clark Blake', '3th Microraion d. 61'),
        (86, 'Silver Avenue', 'Gregory Miller', '3th Microraion d. 1'),
        (87, 'Art Lane', 'Pearson Campbell', '3th Microraion d. 35'),
        (88, 'Fleet Passage', 'Brown Hall', 'ul. Tsvetochnaya d65'),
        (89, 'Art Lane', 'Alfred Helen', 'Castle Court d.42'),
        (90, 'Fleet Passage', 'Michelle Jennifer', 'Hazelnut Lane d.58'),
        (91, 'Knight Lane', 'Estrada Blake', 'Brewers Lane d.43'),
        (92, 'Fleet Passage', 'Morrison Matthew', 'Microraion Zelenyi d. 63'),
        (93, 'Silver Avenue', 'Atkins David', 'prosp. Stroiteley d. 9'),
        (94, 'Winter Way', 'Daniel Dorothy', 'Bolton Road d. 22'),
        (95, 'Art Lane', 'Morrison Joseph', 'Brewers Lane d.49'),
        (96, 'Silver Avenue', 'Dorothy James', 'Bolton Road d. 24'),
        (97, 'Hawthorn Way', 'Campbell Collins', 'Alexander Street d. 36'),
        (98, 'Silver Avenue', 'Betty Ruiz', 'prosp. Stroiteley d. 65'),
        (99, 'Brewers Lane', 'Brown Carrie', 'ul. Tsvetochnaya d43'),
        (100, 'Art Lane', 'Eugene Smith', 'prosp. Stroiteley d. 9');

ALTER TABLE customer ADD CONSTRAINT fk_customer1 PRIMARY KEY (kod_customer);
ALTER TABLE scontract ADD CONSTRAINT fk_customer1 FOREIGN KEY (kod_customer) REFERENCES customer (kod_customer);


ALTER TABLE warehouse ADD CONSTRAINT fk_warehouse PRIMARY KEY (kod_warehouse);
ALTER TABLE invoice ADD CONSTRAINT fk_warehouse FOREIGN KEY (kod_warehouse) REFERENCES warehouse (kod_warehouse);
ALTER TABLE shipment ADD CONSTRAINT fk_warehouse FOREIGN KEY (kod_warehouse) REFERENCES warehouse (kod_warehouse);